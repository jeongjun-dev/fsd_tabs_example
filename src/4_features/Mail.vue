...
import AccountSwitcher from "@/3_widgets/AccountSwitcher.vue";
import MailList from "@/4_features/MailList.vue";
import MailDisplay from "@/3_widgets/MailDisplay.vue";
import Nav, { type LinkProp } from "@/3_widgets/Nav.vue";
import { cn } from "@/6_shared/lib/utils";
import { Separator } from "@/6_shared/lib/registry/new-york/ui/separator";
import { Input } from "@/6_shared/lib/registry/new-york/ui/input";
import {
  Tabs,
  TabsContent,
  TabsList,
  TabsTrigger,
} from "@/6_shared/lib/registry/new-york/ui/tabs";
import { TooltipProvider } from "@/6_shared/lib/registry/new-york/ui/tooltip";
import {
  ResizableHandle,
  ResizablePanel,
  ResizablePanelGroup,
} from "@/6_shared/lib/registry/new-york/ui/resizable";
