...
import {
  ...
  DropdownMenuItem,
  DropdownMenuTrigger,
} from "@/6_shared/lib/registry/new-york/ui/dropdown-menu";
import {
  Popover,
  PopoverContent,
  PopoverTrigger,
} from "@/6_shared/lib/registry/new-york/ui/popover";
import {
  Avatar,
  AvatarFallback,
} from "@/6_shared/lib/registry/new-york/ui/avatar";
import { Button } from "@/6_shared/lib/registry/new-york/ui/button";
import { Label } from "@/6_shared/lib/registry/new-york/ui/label";
import { Separator } from "@/6_shared/lib/registry/new-york/ui/separator";
import { Switch } from "@/6_shared/lib/registry/new-york/ui/switch";
import { Textarea } from "@/6_shared/lib/registry/new-york/ui/textarea";
import {
  Tooltip,
  TooltipContent,
  TooltipTrigger,
} from "@/6_shared/lib/registry/new-york/ui/tooltip";
